...
- We have a Postman collection you can download to get up and running. [Current API](https://cdn.current.tech/deleloper-resources/api-resources/Current_API.postman_collection.json)
